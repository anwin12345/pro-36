class Question {
  ...
  display(){
    ...
    this.question.html("What mouse do I use? ")
    this.question.position(350, 50);

    this.option1.html("a. Glorious Model O")
    this.option2.html("b. ROCCAT KONE Pure Owl-Eye")
    this.option3.html("c. Bloody A70")
    this.option4.html("d. ROCCAT KONE XTD")
